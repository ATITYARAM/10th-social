# Contributing to 10th Social Science

Thank you for your interest in contributing to **10th Social Science**! We welcome contributions from the community to help improve and expand educational resources.
...
2. **Clone your Fork**:
   ```bash
   git clone https://github.com/<your-username>/10th-social.git
   cd 10th-social
   ```
